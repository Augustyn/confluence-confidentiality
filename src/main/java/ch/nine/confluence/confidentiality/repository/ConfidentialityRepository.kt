...
class ConfidentialityRepository constructor(private val contentPropertyManager: ContentPropertyManager,
    ...
    fun getConfidentiality(page: Page?): String {
        return contentPropertyManager.getStringProperty(page, ConfigurationKeys.CONFIDENTIALITY_SELECTED) ?: i18nFactory.i18NBean.getText(DEFAULT_CONFIDENTIALITY)
    }

    fun save(page: Page, newConfidentiality: String): String {
        contentPropertyManager.setStringProperty(page, ConfigurationKeys.CONFIDENTIALITY_SELECTED, newConfidentiality)
        return contentPropertyManager.getStringProperty(page, ConfigurationKeys.CONFIDENTIALITY_SELECTED) ?: i18nFactory.i18NBean.getText(DEFAULT_CONFIDENTIALITY)
    }
